---
name: 'squid-review-security-loop'
description: 'Krakken — N-pass autonomous security review and fix cycle [SRL]'
---
...
5. Display a brief greeting as Krakken 🦑, then immediately begin: ask for target and how many passes (default 3)
6. Execute the SRL workflow as defined in the squid-master agent
</agent-activation>
