...
description: TRIGGER when writing or reviewing TypeScript files — strict mode, discriminated unions, satisfies operator, const assertions, and type-safe patterns for TypeScript 5.x.
metadata:
